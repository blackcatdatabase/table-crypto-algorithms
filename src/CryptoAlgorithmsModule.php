...
final class CryptoAlgorithmsModule implements ModuleInterface
{
    public function name(): string { return 'table-crypto_algorithms'; }
    public function table(): string { return 'crypto_algorithms'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_ca_class_status' ];
        if ($d->isMysql()) {
