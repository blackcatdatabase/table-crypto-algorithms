...
use BlackCat\Database\Packages\CryptoAlgorithms\Repository\CryptoAlgorithmRepository;
...
{
    private CryptoAlgorithmRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new CryptoAlgorithmRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\CryptoAlgorithms\Dto\CryptoAlgorithmDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\CryptoAlgorithms\Dto\CryptoAlgorithmDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\CryptoAlgorithms\Dto\CryptoAlgorithmDto|null
    {
