...
namespace BlackCat\Database\Packages\CryptoAlgorithms;
...
use BlackCat\Database\Packages\CryptoAlgorithms\Repository\CryptoAlgorithmRepository as GeneratedRepository;
...
{
  private CryptoAlgorithmRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof CryptoAlgorithmRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected CryptoAlgorithmRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\CryptoAlgorithms\Dto\CryptoAlgorithmDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\CryptoAlgorithms\Dto\CryptoAlgorithmDto|null { return $this->repo->getById($id, $asDto); }
