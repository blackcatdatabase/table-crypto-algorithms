...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'crypto_algorithms'; }
    public static function contractView(): string { return 'vw_crypto_algorithms'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'class', 'name', 'variant', 'variant_norm', 'nist_level', 'status', 'params', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'class', 'name', 'variant_norm' ], [ 'class', 'name', 'variant' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'nist_level' ]; }
    ...
    public static function generatedColumns(): array { return [ 'variant_norm' ]; }
