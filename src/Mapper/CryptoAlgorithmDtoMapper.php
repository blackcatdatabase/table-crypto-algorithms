...
namespace BlackCat\Database\Packages\CryptoAlgorithms\Mapper;

use BlackCat\Database\Packages\CryptoAlgorithms\Dto\CryptoAlgorithmDto;
use BlackCat\Database\Packages\CryptoAlgorithms\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO CryptoAlgorithmDto:
...
final class CryptoAlgorithmDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'nist_level' ];
    /** @var string[] */
     ...
     * @return CryptoAlgorithmDto
     */
    public static function fromRow(array $row): CryptoAlgorithmDto
    {
        /** @var CryptoAlgorithmDto */
        return DtoHydrator::fromRow(
            CryptoAlgorithmDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?CryptoAlgorithmDto
    {
     ...
     *
     * @param CryptoAlgorithmDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(CryptoAlgorithmDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(CryptoAlgorithmDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(CryptoAlgorithmDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,CryptoAlgorithmDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,CryptoAlgorithmDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(CryptoAlgorithmDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,CryptoAlgorithmDto>
     */
