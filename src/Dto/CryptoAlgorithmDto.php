...
namespace BlackCat\Database\Packages\CryptoAlgorithms\Dto;
 ...
 */
final class CryptoAlgorithmDto implements \JsonSerializable {
    public function __construct(
        public readonly int $id,
        public readonly string $class,
        #[\SensitiveParameter] public readonly string $name,
        public readonly ?string $variant,
        public readonly ?string $variantNorm,
        public readonly ?int $nistLevel,
